...
def call_sglang(args, server_address: str, data: List[Dict]) -> Dict[str, Any]:
    """单条数据处理核心逻辑"""
...
def main():
    ...
    with open(args.output_file_path, "w", encoding="utf-8") as out_f, \
        ...
        for i, item in enumerate(all_data):
            ...
            futures.append(executor.submit(call_sglang, args, target_server, item["conversations"][0]["content"]))
